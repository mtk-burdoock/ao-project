...
Sub SwitchMap(ByVal Map As Integer)
    ...
    If FileExist(Game.path(Minimap) & Map & ".bmp", vbArchive) Then
        frmMain.MiniMapa.Picture = LoadPicture(Game.path(Minimap) & Map & ".bmp")
    Else
...
Private Sub LoadInitialConfig()
    ...
    End If
    Set picMouseIcon = LoadPicture(Game.path(Puntero) & "Baston.ico")
    Dim CursorAniDir As String
    Dim Cursor As Long
    CursorAniDir = Game.path(Puntero) & "General.ani"
