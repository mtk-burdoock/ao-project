...
Public Sub IniciarCabecera()
    With MiCabecera
        .Desc = "AO Project by Burdoock. Copyright Gonzalo Gonzalez 2024, burdoock@gmail.com"
        .CRC = Rnd * 100
        .MagicWord = Rnd * 10
    End With
End Sub
...
Public Function path(ByVal PathType As ePath) As String
    Select Case PathType
        Case ePath.INIT
            path = App.path & "\..\ao-project-resources\init\"
        
        Case ePath.Graficos
            path = App.path & "\..\ao-project-resources\graphics\sprites\"
            
        Case ePath.Puntero
            path = App.path & "\..\ao-project-resources\graphics\mouse_pointers\"
            
        Case ePath.Buttons
            path = App.path & "\..\ao-project-resources\graphics\buttons\"
            
        Case ePath.Minimap
            path = App.path & "\..\ao-project-resources\graphics\minimap\"
        
        Case ePath.Skins
            path = App.path & "\..\ao-project-resources\graphics\themes\"
            
        Case ePath.Sprites
            path = App.path & "\..\ao-project-resources\graphics\sprites\"
            
        Case ePath.Interfaces
            path = App.path & "\..\ao-project-resources\graphics\interfaces\"
            
        Case ePath.Fonts
            path = App.path & "\..\ao-project-resources\graphics\fonts\"
            
        Case ePath.Lenguajes
            path = App.path & "\..\ao-project-resources\languages\"
            
        Case ePath.Mapas
            path = App.path & "\..\ao-project-resources\maps\"
            
        Case ePath.Musica
            path = App.path & "\..\ao-project-resources\sounds\MIDI\"

        Case ePath.MusicaMp3
            path = App.path & "\..\ao-project-resources\sounds\MP3\"
            
        Case ePath.Sounds
            path = App.path & "\..\ao-project-resources\sounds\WAV\"
            
        Case ePath.Extras
            path = App.path & "\..\ao-project-resources\extras\"

        Case ePath.Videos
            Dim VideosPath As String
            VideosPath = App.path & "\..\ao-project-resources\videos\"
...
Public Function pathTheme(ByVal PathType As eTheme) As String
    Select Case PathType
        Case eTheme.Libre
            pathTheme = App.path & "\..\ao-project-resources\graphics\themes\Libre\"
        
        Case eTheme.Psicodelico
            pathTheme = App.path & "\..\ao-project-resources\graphics\themes\Psicodelico\"
        
        Case eTheme.Oscuro
            pathTheme = App.path & "\..\ao-project-resources\graphics\themes\Oscuro\"
    End Select
End Function
