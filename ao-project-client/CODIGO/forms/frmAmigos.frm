...
Begin VB.Form frmAmigos 
   ...
   Begin VB.ListBox ListAmigos 
      ...
      Width           =   3495
   End
   Begin AOProjectClient.uAOButton AgregarAmigo 
      Height          =   375
      Left            =   600
      TabIndex        =   2
      Top             =   4560
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmAmigos.frx":0000
      PICF            =   "frmAmigos.frx":001C
      PICH            =   "frmAmigos.frx":0038
      PICV            =   "frmAmigos.frx":0054
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton BorrarAmigo 
      Height          =   375
      Left            =   2040
      TabIndex        =   3
      Top             =   4560
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmAmigos.frx":0070
      PICF            =   "frmAmigos.frx":008C
      PICH            =   "frmAmigos.frx":00A8
      PICV            =   "frmAmigos.frx":00C4
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   9
         Charset         =   0
   ...
   Begin AOProjectClient.uAOButton btnSalir 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmAmigos.frx":00E0
      PICF            =   "frmAmigos.frx":00FC
      PICH            =   "frmAmigos.frx":0118
      PICV            =   "frmAmigos.frx":0134
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   9
         Charset         =   0
