...
Begin VB.Form frmMain 
   ...
   Visible         =   0   'False
   Begin AOProjectClient.uAOProgress uAOProgressDownloadFfmpeg 
      Height          =   255
      Left            =   2160
      TabIndex        =   48
   ...
   Begin VB.Timer timerPasarSegundo 
      ...
      Top             =   2880
   End
   Begin AOProjectClient.uAOProgress uAOProgressExperienceLevel 
      Height          =   255
      Left            =   12240
      TabIndex        =   40
   ...
   Begin VB.PictureBox MainViewPic 
      ...
      End
   End
   Begin AOProjectClient.uAOButton btnMapa 
      Height          =   255
      Left            =   11880
      TabIndex        =   28
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnGrupo 
      Height          =   255
      Left            =   11880
      TabIndex        =   31
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnOpciones 
      Height          =   255
      Left            =   13440
      TabIndex        =   32
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnEstadisticas 
      Height          =   255
      Left            =   11880
      TabIndex        =   33
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnClanes 
      Height          =   255
      Left            =   11880
      TabIndex        =   34
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnInventario 
      Height          =   495
      Left            =   11880
      TabIndex        =   35
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnHechizos 
      Height          =   495
      Left            =   13440
      TabIndex        =   36
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnLanzar 
      Height          =   495
      Left            =   11880
      TabIndex        =   22
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnInfo 
      Height          =   495
      Left            =   13680
      TabIndex        =   38
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnRetos 
      Height          =   255
      Left            =   13440
      TabIndex        =   43
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnAmigos 
      Height          =   255
      Left            =   13440
      TabIndex        =   44
      TabStop         =   0   'False
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnQuests 
      Height          =   255
      Left            =   13440
      TabIndex        =   45
      TabStop         =   0   'False
   ...
   Begin RichTextLib.RichTextBox RecTxt 
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnReportarBug 
      Height          =   255
      Left            =   120
      TabIndex        =   46
      Top             =   1995
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton btnGrabarVideo 
      Height          =   255
      Left            =   1560
      TabIndex        =   47
      Top             =   1995
...
Private Sub btnGrabarVideo_Click()
    ...
    If Not bIsRecordingVideo Then
        ...
        FileName = Format$(Now, "DD-MM-YYYY-hh.mm.ss") & "_ao-project.mkv"
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        ...
        Case CustomKeys.BindedKey(eKeyType.mKeyAttack)
            ...
            If trainingMacro.Enabled Then Call DesactivarMacroHechizos
            If macrotrabajo.Enabled Then Call DesactivarMacroTrabajo
            If frmCustomKeys.Visible Then Exit Sub
            Call WriteAttack
...
Private Sub btnLanzar_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    UsaMacro = False
    CnTd = 0
End Sub
...
Public Sub SetGoldColor()
    If UserGLD >= CLng(UserLvl) * 10000 And UserLvl > 12 Then
