...
Begin VB.Form frmConnect 
   ...
   Begin AOProjectClient.uAOButton btnSalir 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmConnect.frx":5D02B
      PICF            =   "frmConnect.frx":5DA55
      PICH            =   "frmConnect.frx":5E717
      PICV            =   "frmConnect.frx":5F6A9
   ...
   Begin AOProjectClient.uAOButton btnRecuperar 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmConnect.frx":605AB
      PICF            =   "frmConnect.frx":60FD5
      PICH            =   "frmConnect.frx":61C97
      PICV            =   "frmConnect.frx":62C29
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   8.25
         Charset         =   0
   ...
   Begin AOProjectClient.uAOButton btnCrearCuenta 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmConnect.frx":63B2B
      PICF            =   "frmConnect.frx":64555
      PICH            =   "frmConnect.frx":65217
      PICV            =   "frmConnect.frx":661A9
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   9.75
         Charset         =   0
   ...
   Begin AOProjectClient.uAOButton btnTeclas 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmConnect.frx":670AB
      PICF            =   "frmConnect.frx":67AD5
      PICH            =   "frmConnect.frx":68797
      PICV            =   "frmConnect.frx":69729
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   8.25
         Charset         =   0
   ...
   Begin AOProjectClient.uAOButton btnConectarse 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmConnect.frx":6A62B
      PICF            =   "frmConnect.frx":6B055
      PICH            =   "frmConnect.frx":6BD17
      PICV            =   "frmConnect.frx":6CCA9
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   8.25
         Charset         =   0
