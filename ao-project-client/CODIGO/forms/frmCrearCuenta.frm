...
Begin VB.Form frmCrearCuenta 
   ...
   Begin AOProjectClient.uAOButton imgSalir 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmCrearCuenta.frx":0000
      PICF            =   "frmCrearCuenta.frx":0A2A
      PICH            =   "frmCrearCuenta.frx":16EC
      PICV            =   "frmCrearCuenta.frx":267E
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgCrearCuenta 
      Height          =   495
      Left            =   4440
      TabIndex        =   4
      Top             =   3720
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmCrearCuenta.frx":3580
      PICF            =   "frmCrearCuenta.frx":3FAA
      PICH            =   "frmCrearCuenta.frx":4C6C
      PICV            =   "frmCrearCuenta.frx":5BFE
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Calibri"
         Size            =   9.75
         Charset         =   0
