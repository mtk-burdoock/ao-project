...
Begin VB.Form frmPanelAccount 
   ...
   Begin AOProjectClient.uAOButton uAOBorrarPersonaje 
      Height          =   615
      Left            =   840
      TabIndex        =   27
      Top             =   6360
      ...
      FCOL            =   255
      OCOL            =   16777215
      PICE            =   "frmPanelAccount.frx":0000
      PICF            =   "frmPanelAccount.frx":001C
      PICH            =   "frmPanelAccount.frx":0038
      PICV            =   "frmPanelAccount.frx":0054
   ...
   Begin VB.PictureBox picChar 
      ...
      Width           =   1140
   End
   Begin AOProjectClient.uAOButton uAOConectar 
      Height          =   615
      Left            =   9120
      TabIndex        =   28
      Top             =   7920
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmPanelAccount.frx":0070
      PICF            =   "frmPanelAccount.frx":008C
      PICH            =   "frmPanelAccount.frx":00A8
      PICV            =   "frmPanelAccount.frx":00C4
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton uAOCrearPersonaje 
      Height          =   615
      Left            =   5040
      TabIndex        =   29
      Top             =   7920
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmPanelAccount.frx":00E0
      PICF            =   "frmPanelAccount.frx":00FC
      PICH            =   "frmPanelAccount.frx":0118
      PICV            =   "frmPanelAccount.frx":0134
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton uAOSalir 
      Height          =   615
      Left            =   960
      TabIndex        =   30
      Top             =   7920
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmPanelAccount.frx":0150
      PICF            =   "frmPanelAccount.frx":016C
      PICH            =   "frmPanelAccount.frx":0188
      PICV            =   "frmPanelAccount.frx":01A4
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
