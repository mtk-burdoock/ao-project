...
Public Function BuscarSlotAmigoName(ByVal Userindex As Integer, ByVal Nombre As String) As Boolean
    Dim i As Long
    For i = 1 To MAXAMIGOS
...
Public Function BuscarSlotAmigoNameSlot(ByVal Userindex As Integer, ByVal Nombre As String) As Byte
    Dim i As Long
    For i = 1 To MAXAMIGOS
        If UCase$(UserList(Userindex).Amigos(i).Nombre) = UCase$(Nombre) Then
...
Public Function AgregarAmigo(ByVal Userindex As Integer, ByVal Otro As Integer, ByRef razon As String) As Boolean
    With UserList(Userindex)
...
Public Sub ActualizarSlotAmigo(ByVal Userindex As Integer, ByVal Slot As Byte, Optional ByVal Todo As Boolean = False)
    Dim i As Long
    With UserList(Userindex)
        If Todo Then
            For i = 1 To MAXAMIGOS
...
Public Function ObtenerIndexUsuado(ByVal Userindex As Integer, ByVal Otro As Integer) As Integer
    Dim i As Long
    For i = 1 To MAXAMIGOS
