...
Sub CloseSocket(ByVal Userindex As Integer)
    ...
    With UserList(Userindex)
        ...
        If .flags.SlotReto > 0 Then
            Call modRetos.UserDieFight(Userindex, 0, True)
        End If
...
Function HayPCarea(Pos As tWorldPos) As Boolean
    Dim X As Integer, Y As Integer
...
Function HayOBJarea(Pos As tWorldPos, ObjIndex As Integer) As Boolean
    Dim X As Integer, Y As Integer
    For Y = Pos.Y - MinYBorder + 1 To Pos.Y + MinYBorder - 1
        For X = Pos.X - MinXBorder + 1 To Pos.X + MinXBorder - 1
...
Sub CloseUser(ByVal Userindex As Integer)
    ...
    With UserList(Userindex)
        ...
        If .PartyIndex > 0 Then Call modParty.SalirDeParty(Userindex)
