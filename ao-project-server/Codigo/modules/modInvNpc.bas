...
Public Function TirarItemAlPiso(Pos As tWorldPos, obj As obj, Optional NotPirata As Boolean = True) As tWorldPos
...
Public Sub TirarOroNpc(ByVal Cantidad As Long, ByRef Pos As tWorldPos, ByVal Userindex As Integer)
    On Error GoTo ErrorHandler
    If Cantidad > 0 Then
