...
Type MapInfo
    ...
    MusicMp3 As String
    Name As String
    StartPos As tWorldPos
    OnDeathGoTo As tWorldPos
...
Public Ciudades(1 To NUMCIUDADES)         As tWorldPos
...
Public Nix             As tWorldPos
Public Ullathorpe      As tWorldPos
Public Banderbill      As tWorldPos
Public Lindos          As tWorldPos
Public Arghal          As tWorldPos
Public Arkhein         As tWorldPos
Public Nemahuak        As tWorldPos
Public Prision         As tWorldPos
Public Libertad        As tWorldPos
Public Gotland         As tWorldPos
Public Perdida         As tWorldPos
Public Totem           As tWorldPos
Public CustomSpawnMap  As tWorldPos
Public Ayuda           As clsCola
Public Denuncias       As clsCola
