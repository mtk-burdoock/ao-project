...
Public Sub RestaCount(ByVal Userindex As Integer, Optional ByVal Flecha As Byte = 0, Optional ByVal Golpe As Byte = 0, Optional ByVal Cast As Byte = 0, Optional ByVal Usar As Byte = 0)
    With UserList(Userindex)
        If (Flecha <> 0) Then
            .Counters.Cheat.AtacaArco = 0
        End If
...
Public Sub AddCount(ByVal Userindex As Integer, Optional ByVal AddFlecha As Byte = 0, Optional ByVal AddGolpe As Byte = 0, Optional ByVal AddCast As Byte = 0, Optional ByVal AddUsar As Byte = 0)
    Dim Msj As String
    With UserList(Userindex)
        If (AddFlecha <> 0) Then
...
Private Function CheckInt(ByVal Userindex As Integer, ByRef Msj As String, ByVal Intervalo As Byte) As Boolean
