        ...
        With UserList(Userindex)
            ...
            If MiNPC.flags.ExpCount > 0 Then
                If .PartyIndex > 0 Then
                    Call modParty.ObtenerExito(Userindex, MiNPC.flags.ExpCount, MiNPC.Pos.Map, MiNPC.Pos.X, MiNPC.Pos.Y)
                Else
...
Private Function TestSpawnTrigger(Pos As tWorldPos, Optional PuedeAgua As Boolean = False) As Boolean
...
Public Function CrearNPC(NroNPC As Integer, Mapa As Integer, OrigPos As tWorldPos, Optional ByVal CustomHead As Integer) As Integer
    Dim Pos            As tWorldPos
    Dim newPos         As tWorldPos
    Dim altpos         As tWorldPos
...
Function SpawnNpc(ByVal NpcIndex As Integer, Pos As tWorldPos, ByVal FX As Boolean, ByVal Respawn As Boolean) As Integer
    Dim newPos         As tWorldPos
    Dim altpos         As tWorldPos
    Dim nIndex         As Integer
    Dim PosicionValida As Boolean
