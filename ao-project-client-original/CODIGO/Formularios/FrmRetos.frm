...
Begin VB.Form FrmRetos 
   ...
   Begin VB.TextBox txtOponente 
      ...
      Width           =   1815
   End
   Begin AOProjectClient.uAOButton Comenzar 
      Height          =   615
      Left            =   5400
      TabIndex        =   12
      TabStop         =   0   'False
...
Private Function CheckDataReto(ByVal Selected As Byte, ByRef ListUser As String, ByRef ErrorMsg As String) As Boolean
    CheckDataReto = False
    Dim a As Long
