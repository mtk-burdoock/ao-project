...
Begin VB.Form frmCambiaMotd 
   ...
   Begin AOProjectClient.uAOButton imgAceptar 
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgAzul 
      Height          =   375
      Left            =   480
      TabIndex        =   5
      Top             =   3240
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgRojo 
      Height          =   375
      Left            =   1560
      TabIndex        =   6
      Top             =   3240
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgBlanco 
      Height          =   375
      Left            =   2640
      TabIndex        =   7
      Top             =   3240
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgGris 
      Height          =   375
      Left            =   3720
      TabIndex        =   8
      Top             =   3240
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgMarron 
      Height          =   375
      Left            =   3720
      TabIndex        =   9
      Top             =   3720
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgVerde 
      Height          =   375
      Left            =   2640
      TabIndex        =   10
      Top             =   3720
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgMorado 
      Height          =   375
      Left            =   1560
      TabIndex        =   11
      Top             =   3720
      ...
      EndProperty
   End
   Begin AOProjectClient.uAOButton imgAmarillo 
      Height          =   375
      Left            =   480
      TabIndex        =   12
      Top             =   3720
